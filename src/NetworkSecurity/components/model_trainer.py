...
from NetworkSecurity.utils.ml_utils import NetworkModel,evaluate_models
from NetworkSecurity.utils.utils import save_pickle,load_pickle
from NetworkSecurity.utils.utils import load_numpy_array
from NetworkSecurity.utils.ml_utils import get_classification_details
...
import dagshub
dagshub.init(repo_owner='irshadmuhammed', repo_name='Network-Security', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,x_test,y_test):
        ...
        classification_train_metric=get_classification_details(y_true=y_train,y_pred=y_train_pred)
        ...
        classification_test_metric=get_classification_details(y_true=y_test,y_pred=y_test_pred)

        self.track_mlflow(best_model,classification_test_metric)

        preprocessor = load_pickle(file_path=self.data_transformation_artifact.transformed_object_file_path)
        ...
        save_pickle(self.model_trainer_config.trained_model_file_path,NetworkModel)
